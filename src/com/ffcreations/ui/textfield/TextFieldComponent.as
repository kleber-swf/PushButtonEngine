package com.ffcreations.ui.textfield {
	...
	public class TextFieldComponent extends DisplayObjectRenderer {
		...
		/**
		 * Property where to get the html text for this component.
		 */
		public var htmlTextProperty:PropertyReference;
		/**
		 ...
		 */
		public function get antiAlias():String { return _field.antiAliasType; }
		
		/** @private */
		public function set antiAlias(value:String):void { _field.antiAliasType = value; }
		 ...
		 */
		public function get autoSize():String { return _field.autoSize; }
		 ...
		 */
		public function get background():Boolean { return _field.background; }
		
		/** @private */
		public function set background(value:Boolean):void { _field.background = value; }
		 ...
		 */
		public function get backgroundColor():uint { return _field.backgroundColor; }
		 ...
		 */
		public function get border():Boolean { return _field.border; }
		
		/** @private */
		public function set border(value:Boolean):void { _field.border = value; }
		 ...
		 */
		public function get borderColor():uint { return _field.borderColor; }
		 ...
		 */
		public function get editable():Boolean { return _field.type == TextFieldType.INPUT; }
		...
		/** @private */
		public function set embedFonts(value:Boolean):void { _field.embedFonts = value; }
		 ...
		 */
		public function get maxChars():int { return _field.maxChars; }
		
		/** @private */
		public function set maxChars(value:int):void { _field.maxChars = value; }
		
		/** Text field maximum size (pixels). */
		public function get maxSize():Point { return _maxSize; }
		
		/**  @private */
		public function set maxSize(value:Point):void { _maxSize = value; }
		
		/** Text field minimum size (pixels). */
		public function get minSize():Point { return _minSize; }
		
		/** @private */
		public function set minSize(value:Point):void { _minSize = value; }
		 ...
		 */
		public function get multiline():Boolean { return _field.multiline; }
		
		/**  @private */
		public function set multiline(value:Boolean):void { _field.multiline = value; }
		 ...
		 */
		public function get password():Boolean { return _field.displayAsPassword; }
		
		/** @private */
		public function set password(value:Boolean):void { _field.displayAsPassword = value; }
		 ...
		 */
		public function get restrict():String { return _field.restrict; }
		
		/** @private */
		public function set restrict(value:String):void { _field.restrict = value; }
		 ...
		 */
		public function get selectable():Boolean { return _field.selectable; }
		 ...
		 */
		public function get tabEnabled():Boolean { return _field.tabEnabled; }
		
		/** @private */
		public function set tabEnabled(value:Boolean):void { _field.tabEnabled = value; }
		 ...
		 */
		public function get tabIndex():int { return _field.tabIndex; }
		
		/** @private */
		public function set tabIndex(value:int):void { _field.tabIndex = value; }
		...
		protected function setText(value:String):void { _field.text = value ? value : ""; }
		 ...
		 */
		public function get textFormat():TextFormat { return _field.defaultTextFormat; }
		 ...
		 */
		public function get wordWrap():Boolean { return _field.wordWrap; }
		
		/** @private */
		public function set wordWrap(value:Boolean):void { _field.wordWrap = value; }
		
		/** Padding to apply to the text (only woks with left and top. */
		...
		/**
		 * Caches the TextField as a Bitmap
		 * @see http://help.adobe.com/en_US/FlashPlatform/reference/actionscript/3/flash/display/DisplayObject.html#cacheAsBitmap
		 */
		public function get cacheAsBitmap():Boolean { return _field.cacheAsBitmap; }
		
		public function set cacheAsBitmap(value:Boolean):void { _field.cacheAsBitmap = value; }
		...
		protected function updateCustomProperties():void {
			if (textProperty)
				text = owner.getProperty(textProperty, "");
			else if (htmlTextProperty)
				htmlText = owner.getProperty(htmlTextProperty, "");
		}
		
		private function updateText():void {
			if (_htmlText)
				setHtmlText(_htmlText);
			else if (_text)
				setText(_text);
		}
		...
		public override function updateTransform(updateProps:Boolean = false):void {
			...
			_transformMatrix.translate(_position.x + _positionOffset.x + _padding.left, _position.y + _positionOffset.y + _padding.top);
