...
package com.pblabs.components.stateMachine {
	...
	public class ThinkingMachineInstance extends ThinkingComponent implements IMachine {
		 ...
		 */
		public function get enteredStateTime():Number { return _enteredStateTime; }
		...
		public function get propertyBag():IPropertyBag { return owner; }
		
		public function set propertyBag(value:IPropertyBag):void { throw new Error("Hardcoded"); }
		...
		public function get currentState():IState { return getCurrentState(); }
		
		public function get currentStateName():String { return description.getStateName(getCurrentState()); }
