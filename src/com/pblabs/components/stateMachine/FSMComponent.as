...
package com.pblabs.components.stateMachine {
	...
	public class FSMComponent extends TickedComponent {
		...
		public function get currentState():String { return stateMachine.currentStateName; }
		
		public function set currentState(value:String):void { stateMachine.setCurrentState(value); }
