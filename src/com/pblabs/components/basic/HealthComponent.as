...
package com.pblabs.components.basic {
	...
	public class HealthComponent extends EntityComponent {
		...
		public function get timeSinceLastDamage():Number { return PBE.processManager.virtualTime - _timeOfLastDamage; }
		...
		public function get amountOfDamage():Number { return maxHealth - _health; }
		...
		public function get isDead():Boolean { return _health <= 0; }
