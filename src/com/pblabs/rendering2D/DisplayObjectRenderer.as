...
package com.pblabs.rendering2D {
	...
	public class DisplayObjectRenderer extends AnimatedComponent {
		...
		private var _mask:DisplayObjectRenderer;
		...
		public function get registrationPoint():Point { return _registrationPoint.clone(); }
		...
		public function set blendMode(value:String):void {
			...
			if ((value != BlendMode.ADD) && (value != BlendMode.ALPHA) && (value != BlendMode.DARKEN) && (value != BlendMode.DIFFERENCE) && (value != BlendMode.ERASE) && (value != BlendMode.HARDLIGHT) &&
				(value != BlendMode.INVERT) && (value != BlendMode.LAYER) && (value != BlendMode.LIGHTEN) && (value != BlendMode.MULTIPLY) && (value != BlendMode.NORMAL) && (value != BlendMode.OVERLAY) &&
				(value != BlendMode.SCREEN) && (value != "shader") && // Only supported in Flex 4.0 and higher
		...
		public function get positionOffset():Point { return _positionOffset.clone(); }
		...
		public function get scene():IScene2D { return _scene; }
		 ...
		 */
		[EditorData(ignore="true")]
		public function get renderPosition():Point { return new Point(displayObject.x, displayObject.y); }
		 ...
		 */
		public function get rotationOffset():Number { return PBUtil.getDegreesFromRadians(_rotationOffset); }
		 ...
		 */
		public function set rotationOffset(value:Number):void { _rotationOffset = PBUtil.unwrapRadian(PBUtil.getRadiansFromDegrees(value)); }
		 ...
		 */
		public function transformObjectToWorld(p:Point):Point { return _transformMatrix.transformPoint(p); }
