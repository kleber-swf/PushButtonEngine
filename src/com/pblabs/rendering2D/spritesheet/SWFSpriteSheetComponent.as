...
package com.pblabs.rendering2D.spritesheet {
	...
	public class SWFSpriteSheetComponent extends SpriteContainerComponent implements ISpriteSheet {
		...
		public function get swf():SWFResource { return _resource; }
		 ...
		 */
		public function get bounds():Rectangle { return new Rectangle(_bounds.x, _bounds.y, _bounds.width * _scale.x, _bounds.height * _scale.y); }
		...
		public function set scale(value:Point):void { _scale = value.clone(); }
		...
		public function set imageData(data:BitmapData):void { Logger.warn(this, "imageData", "You can not set raw image data on a swf spritesheet"); }
		...
		/** @private */
		public function set divider(value:ISpriteSheetDivider):void { Logger.warn(this, "divider", "You can not set a divider on a swf spritesheet"); }
