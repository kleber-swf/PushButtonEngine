...
package com.pblabs.box2D {
	...
	public class Box2DSpatialComponent extends TickedComponent implements IMobileSpatialObject2D {
		...
		public function get spatialManager():ISpatialManager2D { return _manager; }
		 ...
		 */
		[EditorData(ignore="true")]
		public function get objectMask():ObjectType { return _collidesWithTypes; }
		...
		public function get collisionType():ObjectType { return _collisionType; }
		...
		public function get collidesWithTypes():ObjectType { return _collidesWithTypes; }
		...
		public function get collisionShapes():Array { return _collisionShapes; }
		...
		private function setupBody():void {
			if ((_manager == null) || (_manager != null && _body != null))
				return;
		...
		private function attachRenderer():void {
			if (!spriteForPointChecks) {
				...
				if (renderer && (!renderer.positionProperty || renderer.positionProperty.property == "" || (renderer.positionProperty && renderer.positionProperty.property.split(".")[0].indexOf("@" + this.name) !=
					-1))) {
