...
package com.pblabs.animation {
	...
	public class AnimatorComponent extends AnimatedComponent {
		...
		public function get currentAnimator():Animator { return _currentAnimation; }
		...
		public function set currentAnimation(animationName:String):void { play(animationName); }
	}
}
