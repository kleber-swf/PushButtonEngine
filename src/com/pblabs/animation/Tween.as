...
package com.pblabs.animation {
	...
	public class Tween extends Object {
		...
		public function get processInterface():Class { return _processInterface; }
		 ...
		 */
		public function Tween(entity:IEntity, object:*, duration:Number, fromVars:*, toVars:*, ease:Function = null, onComplete:Function = null, delay:Number = 0, pingpong:Boolean = false, playCount:int =
							  1, playTime:Number = 0, processMode:int = 1) {
