...
package com.pblabs.animation {
	...
	public class Animator extends EventDispatcher {
		 ...
		 */
		public function get elapsed():Number { return _elapsedTime; }
		...
		public function set startValue(value:*):void { _start = value; }
		...
		public function set targetValue(value:*):void { _target = value; }
		
		/**
		 * The total number of times to repeat the animation.
		 */
		public function get totalRepeatCount():int { return _totalRepeatCount; }
