package com.pblabs.engine.core {
	...
	public final class GlobalExpressionManager implements ITickedObject {
		...
		private function initialize():void {
			...
			if (!objectContext.Game)
				objectContext.Game = new Object();
			if (!objectContext.Game.Mouse)
				objectContext.Game.Mouse = new Object();
			if (!objectContext.Game.Time)
				objectContext.Game.Time = new Object();
			if (!objectContext.Game.Screen)
				objectContext.Game.Screen = new Object();
			if (!objectContext.Game.Level)
				objectContext.Game.Level = new Object();
			objectContext.Game.Level.currentLevel = PBE.levelManager.currentLevel;
		}
	}
}
