package com.pblabs.engine.resource {
	...
	public class ExternalResourceFile extends EventDispatcher {
		...
		public function get isLoaded():Boolean {
			return _loader.contentLoaderInfo.bytesTotal > 5 && _loader.contentLoaderInfo.bytesLoaded >= _loader.contentLoaderInfo.bytesTotal;
		}
		
		private var _didFail:Boolean = false;
		
		public function get didFail():Boolean { return _didFail; }
