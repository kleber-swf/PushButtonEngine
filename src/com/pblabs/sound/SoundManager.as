	...
	public class SoundManager implements ISoundManager, ITickedObject
	{
		...
		internal function updateSounds():void
		{
			...
			for (var i:int = 0; i < playingSounds.length; i++)
			{
				...
				{
					curSoundHandle.channel.soundTransform = SoundCategory.applyCategoriesToTransform(false, curSoundHandle.pan, curSoundHandle.volume, rootCategory, categories[curSoundHandle.category]);
				}
