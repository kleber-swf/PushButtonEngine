...
package com.pblabs.sound {
	...
	public class SoundManager implements ISoundManager, ITickedObject {
		...
		public function get muted():Boolean { return rootCategory.muted; }
		...
		public function get volume():Number { return rootCategory.transform.volume; }
		...
		internal function updateSounds():void {
			...
			for (var i:int = 0; i < playingSounds.length; i++) {
				...
				if (curSoundHandle.channel) {
					curSoundHandle.channel.soundTransform = SoundCategory.applyCategoriesToTransform(
		...
		public function get allCategories():Array {
			...
			for (var s:String in categories)
				result.push(s);
			return result;
		}
	}
